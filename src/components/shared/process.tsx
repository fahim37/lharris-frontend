        ...
        <section className="py-16">
            <div className="container mx-auto">
                <div className="text-center">
                    <h2 className="text-[40px] font-bold text-[#F7E39F] pb-8">How It Works</h2>
                </div>
                <div className="w-full bg-[#0a1155] py-8 px-4 md:py-12 md:px-8">
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col md:flex-row items-center justify-between">
                            {steps.map((step, index) => (
                                <div key={step.number} className="flex flex-col md:flex-row items-center mb-6 md:mb-0">
                                    <div className="flex flex-col items-center">
                                        <div className="flex items-center justify-center w-16 h-16 rounded-full bg-[#f8e9a1] text-[#0a1155] font-bold text-xl">
                                            {step.number}
                                        </div>
                                        <div className="text-white mt-2 text-center font-medium">{step.title}</div>
                                    </div>
