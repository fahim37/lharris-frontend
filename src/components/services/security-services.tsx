        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-[#FFFFFF1A] rounded-lg p-6 flex flex-col">
            ...
            <p className="text-primary mb-4">
              Regularly scheduled patrols to deter criminal activity
            </p>
          ...
          <div className="bg-[#FFFFFF1A] rounded-lg p-6 flex flex-col">
            ...
            <p className="text-primary mb-4">
              Swift response to alarm activations
            </p>
          ...
          <div className="bg-[#FFFFFF1A] rounded-lg p-6 flex flex-col">
            ...
            <p className="text-primary mb-4">
              Monitoring properties while homeowners are away
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-[#FFFFFF1A] rounded-lg p-6 flex flex-col">
            <div className="text-primary mb-4">
              ...
              >
                ...
                />
                <path
                  d="M30 20 m-3,-3 l6,6 m-6,0 l6,-6"
                  stroke="#f0d878"
                  strokeWidth="2"
                />
              </svg>
            ...
            <p className="text-primary mb-4">
              Professional on-site security personnel
            </p>
          ...
          <div className="bg-[#FFFFFF1A] rounded-lg p-6 flex flex-col">
            <div className="text-primary mb-4">
              ...
              >
                <path
                  d="M15 20 H25 V40 H15 Z"
                  stroke="#f0d878"
                  strokeWidth="2"
                  fill="none"
                />
                <path
                  d="M25 25 L40 20 V40 L25 35 Z"
                  stroke="#f0d878"
                  strokeWidth="2"
                  fill="none"
                />
          ...
          <div className="bg-[#FFFFFF1A] rounded-lg p-6 flex flex-col">
            <div className="text-primary mb-4">
              ...
              >
                ...
                />
                <path
                  d="M25 25 H35 M25 30 H35 M25 35 H35"
                  stroke="#f0d878"
                  strokeWidth="2"
                />
                <path
                  d="M30 15 V10 M25 10 H35"
                  stroke="#f0d878"
                  strokeWidth="2"
                />
                <circle
